...
public class RefactorAltaResponsable {
...
private WebDriver driver;
	...
	// CONSTRUCTOR //
	public RefactorAltaResponsable (WebDriver driver) {
		this.driver = driver;
	}
	//LOGIN
	...
	public void ingresoTipoResponsableEmpresa(String tipoResponsable){
		...
		WebElement responsable = wait.until(ExpectedConditions.elementToBeClickable(ByTipoResponsable));
		if (responsable.isDisplayed()) {
			System.out.println("Tipo de responsable es visible: " + responsable);
			if (responsable.isEnabled()) {
				System.out.println("Tipo de responsable esta habilitado: " + responsable);
			}
				if (responsable.isSelected()) {
					System.out.println("Tipo de responsable es seleccioable: " + responsable);
				}
				else {
					responsable.clear();
					responsable.sendKeys(tipoResponsable);
					responsable.submit();
				}
		} else {
			System.out.println("No se muestra: ERROR");
		}
